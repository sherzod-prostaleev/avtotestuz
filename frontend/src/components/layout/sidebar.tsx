          ...
          <nav className="space-y-1">
            ...
            <div className="pt-2">
              <button
                ...
                className="flex w-full items-center justify-between rounded-xl px-3.5 py-2 text-[11px] font-extrabold uppercase tracking-wider text-muted-foreground hover:bg-background hover:text-foreground"
              >
                {t("navMore")}
                <ChevronDown
                  aria-hidden="true"
