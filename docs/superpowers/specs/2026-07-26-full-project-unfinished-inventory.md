...
| **U-45** | P3 | M3 | **Super Admin entire vertical** | partial | Most product features | **SoT locked** (`2026-07-26-m3-super-admin-control-center.md`). **M3-0…M3-4 landed:** auth/RBAC, users, content, payments, **CMS chrome contacts** (`/admin/v1/cms/contacts` + `/{locale}/admin/cms/chrome`; ops contacts deprecated). Ops stubs still under `/{locale}/ops/*`. Next: M3-5 Monitoring, then analytics / flags. |
