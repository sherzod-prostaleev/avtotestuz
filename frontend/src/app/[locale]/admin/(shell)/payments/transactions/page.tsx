...
export default function AdminPaymentsTransactionsPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl space-y-4">
      <header>
        <h1 className="font-display text-2xl font-extrabold tracking-tight">{t("transactionsTitle")}</h1>
        <p className="mt-1 text-sm text-muted-foreground">{t("transactionsSubtitle")}</p>
