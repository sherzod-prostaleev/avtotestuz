...
// [locale]/not-found.tsx: a walk-up student who mistypes a URL must land
// back on /station, never on the public marketing homepage with its
// pricing and login entry points. Keep this in sync with that file's
// structure and styling.
export default async function KioskNotFound() {
