...
3. Fayl har bir sinfxona kompyuterida **bir marta** ishga tushiriladi. Hech narsa qo‘lda kiritilmaydi — kalit faylning ichida keladi. Dastur o‘zini shu PCga o‘rnatadi, Windows bilan birga avtomatik ishga tushishga yoziladi, maktab tashkilotiga ulanadi va kiosk oynasini ochadi.
4. Har bir keyingi yoqilishda kiosk hech kim aralashmasdan o‘zi qayta ochiladi.
