...
| **U-11** | P1 | BE/FE | **M4-08 Web push / campaigns** | **partial** | VAPID keys (ops) | Foundation done: `push_subscription` (0026), `internal/push`, `/me/push*`, profile card + push-only SW. Campaigns/cron/admin broadcast still open; needs `VAPID_*` in env to deliver. |
