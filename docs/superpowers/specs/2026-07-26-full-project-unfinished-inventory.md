...
| **U-45** | P3 | M3 | **Super Admin entire vertical** | partial | Most product features | **SoT locked**. **M3-0…M3-7 + ops→admin deprecation banners.** Broadcast/inbox, logs/alerts, homepage CMS, admin audit/limits write still open. |
