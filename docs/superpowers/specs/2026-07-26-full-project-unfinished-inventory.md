...
| **U-45** | P3 | M3 | **Super Admin entire vertical** | partial | Most product features | **SoT locked.** Thin ops: providers, health, **users**, **payments**, **audit** stubs under `/{locale}/ops/*`. Full RBAC/CMS/monitoring still missing. |
