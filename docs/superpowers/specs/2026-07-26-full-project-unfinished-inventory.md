...
| **U-21** | P2 | BE | **Promo pro-rate user communication** | partial | Billing | Limit exhaustion mid-flight grants fewer days + `entitlement.note`; **user not shown**; no auto-refund/support workflow. |
