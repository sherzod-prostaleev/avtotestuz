...
export function AnswerOption({
  ...
  const stateStyles: Record<string, string> = {
    ...
    correct: "answer-correct-pulse border-success bg-success/10 text-foreground font-bold shadow-3d-success ring-2 ring-success/35",
    wrong: "answer-wrong-pulse border-danger bg-danger/10 text-foreground font-bold shadow-3d-danger ring-2 ring-danger/35",
  };
